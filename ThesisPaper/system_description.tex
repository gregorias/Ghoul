...
Here we will present a distributed protocol which generates a random key that is
...
\subsubsection{SybilControl mechanism}
  SybilControl is fully described in \cite{li12}. Here we will describe the core
...
\subsubsection{SybilControl vulnerabilities}
  ...
  Here we will describe what they are and how does Ghoul
  deal with them.
...
\label{sec:ghoul_summary}
  ...
  \url{https://www.torproject.org/docs/faq\#KeyManagement}}\footnote{
